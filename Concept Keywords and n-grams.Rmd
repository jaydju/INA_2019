...
labls <- c("Computer Science", "Chemistry", "Physics")
par(mar=c(1,1,1,1))
pie(probability, labels = labls, main="Topic Distribution")
...
Remove the Overlap Between Topics
Check for the Journal ARticles
Replace 
